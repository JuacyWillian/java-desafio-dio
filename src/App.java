...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Conteudos inscritos de Camila: " + camila.getConteudosInscritosString() + "\n");
        camila.progredir();
        camila.progredir();
        System.out.println("");
        System.out.println("Conteudos inscritos de Camila: " + camila.getConteudosInscritosString() + "\n");
        System.out.println("Conteudos concluidos de Camila: " + camila.getConteudosConcluidosString() + "\n");
        ...
        System.out.println("Conteudos inscritos de João: " + joao.getConteudosInscritosString() + "\n");
        joao.progredir();
        joao.progredir();
        System.out.println("");
        System.out.println("Conteudos inscritos de João: " + joao.getConteudosInscritosString() + "\n");
        System.out.println("Conteudos concluidos de João: " + joao.getConteudosConcluidosString() + "\n");
